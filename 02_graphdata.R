...
pe_plot1
ggsave((filename = "pe_plot_combined.pdf"), plot=pe_plot1, width = 8, height = 6, useDingbats = F)
...
#####combine 3 plots into one figure
  ...
  pe_plot_agegroup
  ggsave((filename = "pe_plot_agegroup.pdf"), plot=pe_plot_agegroup, width = 16, height = 6, useDingbats = F)
...
##### Combine plots into one figure
  ...
  pe_plot_by_age
  ggsave((filename = "pe_plot_by_age.pdf"), plot=pe_plot_by_age, width = 16, height = 6, useDingbats = F)
...
ggsave(choice_by_age, file="choice_by_age.pdf")
...
ggsave(age_pe_all, filename = "age_pe_all.pdf")
